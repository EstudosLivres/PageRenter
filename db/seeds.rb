...
puts 'Inserting SocialNetworks...'.colorize(:green)
  ...
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Pinterest', acronym: 'Pin', username: 'pinterest', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'reddit', acronym: 'rit', username: 'reddit', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Vimeo', acronym: 'Vi', username: 'vimeo-square', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Flickr', acronym: 'Fr', username: 'flickr', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'YouTube', acronym: 'YT', username: 'youtube', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'SoundCloud', acronym: 'SC', username: 'soundcloud', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'FourSquare', acronym: 'FS', username: 'foursquare', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Delicious', acronym: 'del', username: 'delicious', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Yahoo', acronym: 'Y!', username: 'yahoo', monitoring: false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Microsoft', acronym: 'MS', username: 'windows', monitoring: false})}"
