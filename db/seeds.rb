...
puts 'Inserting SocialNetworks...'.colorize(:green)
  ...
  puts "\t #{SocialNetwork.find_or_create_by({name: 'LinkedIn', acronym: 'in', username: 'linkedin', implemented:false, monitoring: false, just_share:false})}"
  ...
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Vk', acronym: 'Vk', username: 'vk', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Tumblr', acronym: 'Tb', username: 'tumblr', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Pinterest', acronym: 'Pin', username: 'pinterest', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'reddit', acronym: 'rit', username: 'reddit', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Vimeo', acronym: 'Vi', username: 'vimeo-square', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Flickr', acronym: 'Fr', username: 'flickr', implemented:false, monitoring: false, just_share:false})}"
  ...
  puts "\t #{SocialNetwork.find_or_create_by({name: 'SoundCloud', acronym: 'SC', username: 'soundcloud', implemented:false, monitoring: false, just_share:false})}"
  ...
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Delicious', acronym: 'del', username: 'delicious', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Yahoo', acronym: 'Y!', username: 'yahoo', implemented:false, monitoring: false, just_share:false})}"
  puts "\t #{SocialNetwork.find_or_create_by({name: 'Microsoft', acronym: 'MS', username: 'windows', implemented:false, monitoring: false, just_share:false})}"
